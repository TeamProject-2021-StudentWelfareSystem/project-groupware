				...
				<div class="container-fluid">
 					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h5 class="m-0 font-weight-bold text-primary">자료 공유</h5>
						</div>
						<div class="card-body">            
					...
					<div class="form-group col-sm-10 my-5 ml-4">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="boardSubject" name="BoardSubject" 
								placeholder="제목을 입력하세요" value="${BoardSubject}">
						</div>
						</div>
						...
						<div class="user text-center row p-3 ml-5 justify-content-center">
				            ...
				            <a href="${path}/team/documentList"><input type="button" value="이전" id="listButton" class="btn btn-light btn-user"></a>
