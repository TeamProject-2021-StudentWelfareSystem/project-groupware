				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h4 class="m-0 font-weight-bold text-primary">커뮤니티</h4>
						</div>
						<div class="card-body">
										...
										<div class="col-sm-12 col-md-3">
											<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search mt-3 pt-3" >
                        						...
                        						<select class="form-control bg-light border-0 small" id="searchType" name="SearchType"
                        							aria-label="Search" aria-describedby="basic-addon2" style="width:30px;">
									...
									<div class="row">
										...
										<form action="" name="CommunityList" method="POST" id="form">
											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<tbody>
													<c:forEach items="${communityList}" var="communityList" varStatus="status">
													<tr class="odd">
														<td><c:out value="${pageMaker.totalCount - ((pageMaker.cri.page-1) * 10) - status.index}"/></td>
														
														<td id="title" title="${communityList.getBoardSubject()}">
															<a href="${path}/communityContent?no=${communityList.getBoardID()}">
															<c:out value="${communityList.getBoardSubject()}" /></a>
														</td>
											...
											<div class="dataTables_paginate paging_simple_numbers"
											    ...
											    <ul class="pagination">
											        <li class="paginate_button page-item previous ${(pageMaker.cri.page==1) ? 'disabled':''}"
			                                          ...
			                                          <a href='<c:url value="/communityList${pageMaker.makeQuery(pageMaker.startPage-1)}"/>'
			                                          aria-controls="dataTable" data-dt-idx="0" tabindex="0"
			                                          class="page-link">Previous</a></li>
			                                       
			                                       <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
			                                       <li class="paginate_button page-item ${pageMaker.cri.page==pageNum ? 'active':'' }">
			                                          <a href='<c:url value="/communityList${pageMaker.makeQuery(pageNum)}"/>' 
			                                       ...
			                                       <li class="paginate_button page-item next" id="dataTable_next">
			                                          <a href='<c:url value="/communityList${pageMaker.makeQuery(pageMaker.endPage + 1)}"/>'
