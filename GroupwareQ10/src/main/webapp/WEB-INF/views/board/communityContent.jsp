            ...
            <div id="content">
				...
				<form action="CommunityDelete.do?boardID=${BoardID}"
					...
					<div class="form-group col-sm-12">
						...
						<input type="text" class="content-title input-tp font-weight-bold" id="communityTitle" name="CommunityTitle" disabled readonly
							value="${CommunityTitle}">	
						<div class="text-gray-800 row ml-1 my-1">
							<label for="communityWriter" class="col-form-label mr-2"><span class="small">작성자</span></label>
							<input type="text" class="input-sm input-tp small" name="CommunityWriter" id="communityWriter" 
						...
						<div class="row my-3">
							<div class="card-body">
								<div class="ckeditor_contents">
									<p class="card-text">
										<c:out value="${CommunityContent}" escapeXml="false"/>
									</p>
								</div>
							</div>
						</div>
				         ...
				         <div class="row">
				         	...
				         	<div class="col-sm-10 my-2" id="fileIndex">
								<c:forEach var="CommunityFile" items="${CommunityFile}">
					         	<a href="#" onclick="FileDown('${CommunityFile.BFileID}'); return false;">${CommunityFile.BOriginalFileName}</a>(${CommunityFile.BFileSize}kb)<br>
