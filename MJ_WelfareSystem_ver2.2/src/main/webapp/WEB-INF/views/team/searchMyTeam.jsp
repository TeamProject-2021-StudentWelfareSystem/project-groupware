                                    	...
                                    	<table class="table table-bordered dataTable" id="dataTable"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tableindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1" style="width:15%; text-align:center; border-left:hidden;">
															 <input type="submit" class="paginate_button page-item page-link btn-primary active"name="Search" id="search" value="선택" onClick="notSelectValue()"> </th>
