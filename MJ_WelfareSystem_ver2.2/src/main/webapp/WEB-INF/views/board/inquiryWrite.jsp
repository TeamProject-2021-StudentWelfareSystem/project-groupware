				...
				<div class="container-fluid">
				 ...
				 <form action="InquiryWrite.do" name="InquiryWrite" method="POST" id="form">
					<div class="form-group col-sm-10 my-5 ml-4">
						...
						<div class="col ml-4">
							<label for="inquiryEmail" class="col-sm-3 col-form-label"><span class="font-weight-bold text-gray-800">이메일</span></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="inquiryEmail" name="InquiryEmail" readonly
									 value="${InquiryEmail}">
							</div>
						</div>
						<div class="col">	
							<label for="inquiryPhoneNum" class="col-sm-3 col-form-label"><span class="font-weight-bold text-gray-800">연락처</span></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inquiryPhoneNum" name="InquiryPhoneNum" readonly
									value="${InquiryPhoneNum}">
							</div>
						</div>
						</div>
