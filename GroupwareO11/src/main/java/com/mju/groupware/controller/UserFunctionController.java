...
public class UserFunctionController {
	...
	public String home(User user, Principal principal, Model model, HttpServletRequest request,
	...
	public String BlankHome(User user, Principal principal, Model model, HttpServletRequest request,
			Student student, Professor professor) {
		// 유저 정보
				String LoginID = principal.getName();// 로그인 한 아이디
				ArrayList<String> SelectUserProfileInfo = new ArrayList<String>();
