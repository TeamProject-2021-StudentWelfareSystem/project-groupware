				...
				<div class="mcont_width">
					...
					<div class="right_box">
						...
						<section>
							<div class="section2">
								<h3>&nbsp; 사용자 리스트</h3>
								<a href="manageSleep"><input type="button" value="휴면계정관리" id="sleepID"></a>
								<a href="manageSecession"><input type="button" value="탈퇴계정관리" id="deleteID"></a>
								<div id="search">
								...
								<form>
									 <table class="userList">
			                           ...
			                           <tbody>
			                              ...
			                              <td><a href="manageStudent">1</a></td>
			                              <td><a href="manageStudent">학생</a></td>
			                              <td><a href="manageStudent">김아무개</a></td>
			                              <td><a href="manageStudent">kima</a></td>
			                              <td>01012345678</td>
			                              <td>asdf@mju.ac.kr</td>
			                           </tbody>
			                           <tbody>
			                              <th><input type="checkbox" name="check" class="check"></th>
			                              <td>2</td>
