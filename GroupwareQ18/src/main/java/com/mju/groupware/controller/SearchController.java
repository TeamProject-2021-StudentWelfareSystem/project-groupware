...
//		pageMaker.setTotalCount(searchService.CountTotalSearchUser());
//		
//		List<SearchKeyWord> list = searchService.SelectSearchUserPN(cri);
//
...
//		PageMaker pageMaker = new PageMaker();
//		pageMaker.setCri(cri);
//		pageMaker.setTotalCount(searchService.CountTotalUserReview());
//		
//		List<UserReview> list = searchService.SelectUserReviewPN(cri);
//
//		model.addAttribute("list", list);
//		model.addAttribute("pageMaker", pageMaker);
