        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="container-fluid">
				 ...
				 name="NoticeWrite" enctype="multipart/form-data" method="POST" id="form">
					<div class="form-group col-sm-10 my-5 ml-4">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="noticeTitle" name="NoticeTitle" 
								placeholder="제목을 입력하세요" value="${NoticeTitle}">
						</div>
						</div>
						...
						<div class="col-sm-10">
							<textarea name="NoticeContent" class="form-control" id="noticeContent"></textarea>
							<script>
						    ClassicEditor
						...
						<div class="user text-center row p-3 ml-5 justify-content-center">
				            ...
				            <a href="${path}/noticeList"><input type="button" value="이전" id="listButton" class="btn btn-light btn-user"></a>
			            </div>
				</form>
			</div>
			</div>
