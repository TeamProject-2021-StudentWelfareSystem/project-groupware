	...
	<div class="mbody">
		<div class="mcontWidth">
			...
			<div class="rightBox">
				...
				<section>
						<form action="DeleteTeam" name="DeleteTeam"
							method="POST" id="form">
							<div class="section2">
								...
								<table id="contentTable">
									...
									<tr>
										...
										<td><input type="text" name="TeamName"
											id="teamName" class="inputBox" disabled readonly
											value="${TeamName}"></td>
									</tr>	
									...
									<tr>
										...
										<td><input type="text" name="UserName"
											id="userName" class="inputBox" disabled readonly
							...
							<div id="btn">
								...
								<a href="${path}/team/modifyTeam?no=${TeamID}">
