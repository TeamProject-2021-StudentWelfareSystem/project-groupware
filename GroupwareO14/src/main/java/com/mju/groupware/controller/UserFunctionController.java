...
public class UserFunctionController {
	...
	@RequestMapping(value = "/checkPassword2.do", method = RequestMethod.POST)
	   public String checkPassword2(HttpServletResponse response, HttpServletRequest request, Principal Principal) throws IOException {
	...
	/* 수정하기 전 비밀번호 확인 */
	   ...
	   public String checkPassword(HttpServletResponse response, HttpServletRequest request, Principal Principal) throws IOException {
	      ConstantDoFindPassword constantDoFindPassword = (ConstantDoFindPassword) ctx.getBean("DoFindPassword");
