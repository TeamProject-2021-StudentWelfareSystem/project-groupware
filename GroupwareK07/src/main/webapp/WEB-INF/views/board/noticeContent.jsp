			...
			<div class="mbody">
				<div class="mcontWidth">
					...
					<div class="rightBox">
						...
						<section>
						<form action="NoticeDelete.do" name="NoticeDelete"
							method="POST" id="form">
							<div class="section2">
								...
								<table id="contentTable">
									...
									<tr id="content">
										<td><textarea name="NoticeContent"
											id="noticeContent"  class="inputBox"  placeholder="내용" disabled readonly></textarea>
					...
					<div id="btn">
						...
						<c:if test="${UserID == UserIDFromWriter}">
							<a href="${path}/noticeModify?boardID=${BoardID}"><button type="button" id="modifyButton" >수정</button></a>
