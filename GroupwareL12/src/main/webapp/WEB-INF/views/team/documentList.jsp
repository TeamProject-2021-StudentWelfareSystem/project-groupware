						...
						<form action="" name="DocumentList" method="POST" id="form">
								...
								<tbody>
									<c:forEach items="${documentList}" var="documentList"
										...
										<tr>
											...
											<td><a href="${path}/documentContent?no=${documentList.getBoardID()}">
												<c:out value="${documentList.getBoardSubject()}" /></a></td>
											<td><c:out value="${documentList.getBoardWriter()}" /></td>
											<td><c:out value="${documentList.getBoardDate()}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
							...
							<div id="page" class="btn">
								<input type="button" value="←" id="leftList"> <input
									...
									href="${path}/team/documentWrite"><input type="button"
