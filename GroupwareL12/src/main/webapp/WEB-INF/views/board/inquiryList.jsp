										...
										<c:if test="${UserID == UserIDFromWriter}">
											...
											<c:forEach items="${inquiryList}" var="inquiryList"
												...
												<td><c:out value="${status.count}" /></td>
													<td><a href="${path}/inquiryContent?no=${inquiryList.getBoardID()}">
														<c:out value="${inquiryList.getBoardSubject()}" /></a></td>
													<td><c:out value="${inquiryList.getBoardWriter()}" /></td>
													<td><c:out value="${inquiryList.getBoardDate()}" /></td>
