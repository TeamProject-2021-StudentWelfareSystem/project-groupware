...
public class UserListDaoImpl implements UserListDao {
	...
	public WithdrawalProfessor SelectWithdrawalProfessorListForRecovery(String wuserID) {
		WithdrawalProfessor Output = sqlSession.selectOne("SelectWithdrawalProfessorListForRecovery()", wuserID);
		return Output;
	}
	...
	public void InsertProfessorForRecovery(WithdrawalProfessor withdrawalProfessor) {
		...
		sqlSession.insert("InsertProfessorForRecovery()", withdrawalProfessor);
