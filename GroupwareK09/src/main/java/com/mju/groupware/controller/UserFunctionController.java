...
public class UserFunctionController {
	...
	public String DoWithdrawl(HttpServletRequest request, Principal Principal, User user, Student student, Professor professor) {
		ConstantWithdrawal = (ConstantWithdrawal) ctx.getBean("Withdrawal");
		...
		if ((String) request.getParameter(ConstantWithdrawal.getParameter1()) != null) {
			...
			else if(UserInfo.getUserRole().equals("PROFESSOR")) {
