						...
						<table>
							...
							<tr>
								...
								<td class="col2"><select name="StudentGender"
									id="studentGender" value=${StudentGender}>
							...
							<tr>
								<td class="col1"><label for="userColleges">단과대학</label></td>
								<td class="col2"><select name="UserColleges"
									id="userColleges" value=${UserColleges}>
										<option value=" " selected></option>
							...
							<tr>
								<td class="col1"><label for="userMajor">전공</label></td>
								<td class="col2"><select name="UserMajor"
									id="userMajor" value=${UserMajor}>
										<option value=" " selected></option>
							...
							<tr id="doubleMajor">
								...
								<td class="col2"><label for="member_DoubleMajor"> <input
									...
									id="studentDoubleMajor" value=${StudentDoubleMajor}>
										<option value=" " selected></option>
										<option value="국어국문학과">국어국문학과</option>
										<option value="영어영문학과">영어영문학과</option>
										<option value="중어중문학과">중어중문학과</option>
