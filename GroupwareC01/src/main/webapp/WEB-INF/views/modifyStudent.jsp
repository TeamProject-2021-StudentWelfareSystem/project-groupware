						...
						<table>
							...
							<tr>
								...
								<input type="checkbox" name="UserName"
									...
									type="checkbox" name="UserEmail" id="cUserEmail"
									value="">이메일 &nbsp; <input type="checkbox" name="UserPhone"
									id="cUserPhone" value="">연락처 &nbsp;<input type="checkbox" name="UserMajor"
									id="cUserMajor" value="userMajor">전공 &nbsp; <input type="checkbox" name="UserGrade"
