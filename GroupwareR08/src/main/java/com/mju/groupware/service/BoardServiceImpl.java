...
public class BoardServiceImpl implements BoardService {
	...
	public int CountTotalCommunityBoardList(Criteria cri) {
		return boardDao.CountTotalCommunityBoardList(cri);
	}
	
	@Override
	public int CountTotalNoticeBoardList(Criteria cri) {
		return boardDao.CountTotalNoticeBoardList(cri);
	} 

	@Override
	public List<Board> SelectCommunityBoardListPN(Criteria cri) {
		return boardDao.SelectCommunityBoardListPN(cri);
	}

	@Override
	public List<Board> SelectNoticeBoardListPN(Criteria cri) {
		return boardDao.SelectNoticeBoardListPN(cri);
	}

	@Override
	public int CountTotalMyPostList(Criteria cri) {
		return boardDao.CountTotalMyPostList(cri);
	}
