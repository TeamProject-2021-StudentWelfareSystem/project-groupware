...
<link rel="stylesheet" href="../resources/schedule/vendor/css/bootstrap.min.css">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    	...
                    	<div class="row">
                            <div class="col-xs-12">
                                <label class="col-xs-4" for="edit-userId">userId</label>
                                <input type=text name="edit-userId" id="edit-userId" value=${UserId} disabled readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="col-xs-4" for="edit-type">팀 선택</label>
                                <select class="inputModal" type="text" name="edit-type" id="edit-type">
                                <!-- 내가 속한 팀 리스트 출력하고 팀 선택하여 저장 시 해당하는 팀에 속한 사용자들의 일정에도 등록시켜야 함 -->
                                <c:forEach items="${teamList}" var="list">
                                    <option><c:out value="${teamList.getTeamName()}" /></option>
                                </c:forEach>
                                </select>
