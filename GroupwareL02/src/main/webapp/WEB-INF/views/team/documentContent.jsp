		...
		<div class="mbody">
			<div class="mcontWidth">
				...
				<div class="rightBox">
					...
					<section>
						<form action="DocumentDelete.do" name="DocumentDelete" method="POST" id="form">
							<div class="section2">
							...
							<div id="btn">
								<a href="${path}/team/documentList"><input type="button" value="목록"
									id="listButton"></a>
								...
								<!-- 접속한 UserID와 해당 글을 작성한 UserID가 같을 때 수정/삭제 버튼 보이게 하기 -->
								 ...
								 <c:if test="${UserID == UserIDFromWriter}">
									<a href="${path}/team/documentModify?boardID=${BoardID}"><button type="button" id="modifyButton">수정</button></a>
