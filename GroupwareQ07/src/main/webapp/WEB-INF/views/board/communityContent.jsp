            ...
            <div id="content">
				...
				<form action="CommunityDelete.do?boardID=${BoardID}"
					...
					<div class="form-group col-sm-12">
						...
						<input type="text" class="input-sm input-tp font-weight-bold" id="communityTitle" name="CommunityTitle" disabled readonly
						...
						<div class="form-group row my-3">
							<div class="card-body">
								<div class="ckeditor_contents">
									<p class="card-text"><c:out value="${CommunityContent}" escapeXml="false"/></p>
								</div>
							</div>
						</div>
						<hr>
