				...
				<div class="rightBox">
					...
					<section>
						<form action="DocumentDelete.do?tBoardID=${TBoardID}&&teamID=${TeamID}"
								...
								<table>
									<tr>
										...
										<td><c:forEach var="TeamBoardFile"
												items="${TeamBoardFile}">
												<a href="#"
													onclick="FileDown('${TeamBoardFile.TFileID}'); return false;">${TeamBoardFile.TOriginalFileName}</a>(${TeamBoardFile.TFileSize}kb)
										</c:forEach></td>
									</tr>
								</table>
							</div>
							...
							<div id="btn">
								<a href="${path}/team/documentList?no=${TeamID}"><input type="button"
