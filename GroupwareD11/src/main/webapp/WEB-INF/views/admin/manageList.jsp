							...
							<div class="section2">
								...
								<form>
									<table class="userList">
										...
										<c:forEach items="${list}" var="list" varStatus="status">
											<tr>
												<td><input type="checkbox" name="RowCheck" class="check" value="${list.getUserLoginID()}" />
												<script>
								...
								<form>
									<div id="page" class="btn">
										...
										<input type="button" value="삭제" class="deleteButton" id="delete" style="text-align: right;">
										<script>
										// ajax 통신을 위한 csrf 설정
