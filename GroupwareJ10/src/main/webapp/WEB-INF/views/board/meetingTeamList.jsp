			...
			<div class="rightBox">
				...
				<section>
					<div class="section2">
						...
						<form action="" name="MeetingTeamList" method="POST" id="form">
							<input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" />
							<table class="meetingTeamList">
								<thead>
									<tr>
										<th class="col1">번호</th>
								...
								<tbody>
									<c:forEach items="${teamList}" var="teamList"
										...
										<tr>
											...
											<td><a href="${path}/team/meetingLogList?no=${teamList.getTeamID()}">
												<c:out value="${communityList.getSubjectName()}" /></a></td>
											<td><c:out value="${communityList.getProfessorName()}" /></td>
											<td><c:out value="${communityList.getTeamName()}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
