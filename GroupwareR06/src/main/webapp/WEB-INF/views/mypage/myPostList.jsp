				...
				<div class="card shadow mb-4">
						<div class="card-text pt-3 px-3">
							<ul class="nav nav-tabs">
							  ...
							  <li class="nav-item">
							    <a class="nav-link active border-bottom-primary" aria-current="page" href="${path}/myPostList">작성 글 조회</a>
							  </li>
							  <li class="nav-item">
											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<tbody>
													...
													<tr>
														...
														<c:if test="${MyBoardList.getBoardType() eq '커뮤니티' }">
															<td id="title" title="${MyBoardList.getBoardSubject()}">
																<a href="${path}/communityContent?no=${MyBoardList.getBoardID()}">
																	<c:out value="${MyBoardList.getBoardSubject()}" />
																</a>
															</td>
														</c:if>
														<c:if test="${MyBoardList.getBoardType() eq '공지사항' }">
															<td id="title" title="${MyBoardList.getBoardSubject()}">
											...
											<div class="dataTables_paginate paging_simple_numbers"
											    ...
											    <ul class="pagination">
											        <li class="paginate_button page-item previous ${(pageMaker.cri.page==1) ? 'disabled':''}"
			                                          ...
			                                          <a href='<c:url value="/myPostList?page=${pageMaker.cri.page-1}"/>'
			                                          aria-controls="dataTable" data-dt-idx="0" tabindex="0"
			                                          class="page-link">Previous</a></li>
			                                       
			                                       <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
			                                       <li class="paginate_button page-item ${pageMaker.cri.page==pageNum ? 'active':'' }">
			                                          <a href='<c:url value="/myPostList?page=${pageNum}"/>' 
			                                       ...
			                                       <li class="paginate_button page-item next" id="dataTable_next">
			                                          <a href='<c:url value="/myPostList?page=${pageMaker.endPage+1 }"/>'
