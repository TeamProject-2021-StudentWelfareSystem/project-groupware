								...
								<div id="dataTable_wrapper"
									...
									<div class="row mb-3 justify-content-end">
										<div class="col-xs-4 mr-4">
											<form class="d-none d-sm-inline-block form-inline ml-md-3 my-2 my-md-0 mw-10s navbar-search mt-3 pt-3 ml-5" >
                        						...
                        						<select class="form-control bg-light border-0 small" id="searchType" name="SearchType"
                            						...
                            						<input type="text" name="Keyword" id="keyword" class="form-control bg-light border-0 small" placeholder="검색" aria-label="Search" aria-describedby="basic-addon2">
											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<tbody>
													...
													<tr class="odd">
														...
														<td id="title" title="${noticeList.getBoardSubject()}">
														<a href="${path}/noticeContent?no=${noticeList.getBoardID()}">
											...
											<div class="dataTables_paginate paging_simple_numbers"
											    ...
											    <ul class="pagination">
											        <li class="paginate_button page-item previous ${(pageMaker.cri.page==1) ||(pageMaker.cri.page)==(pageMaker.endPage) ? 'disabled':''}"
			                                          ...
			                                          <a href='<c:url value="/noticeList?page=${pageMaker.cri.page-1}"/>'
			                                          aria-controls="dataTable" data-dt-idx="0" tabindex="0"
			                                          class="page-link">Previous</a></li>
			                                       
			                                       <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
			                                       <li class="paginate_button page-item ${pageMaker.cri.page==pageNum ? 'active':'' }">
			                                          <a href='<c:url value="/noticeList?page=${pageNum}"/>' 
			                                       ...
			                                       <li class="paginate_button page-item next" id="dataTable_next">
			                                          <a href='<c:url value="/noticeList?page=${pageMaker.endPage+1 }"/>'
