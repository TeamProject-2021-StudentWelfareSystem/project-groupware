					...
					<div class="rightBox">
						...
						<section>
							<div class="section2">
								...
								<form action="${path}/admin/manageList.do" name="ManageList" method="POST" id="form">
										...
										<tbody>
											<c:forEach items="${list}" var="list" varStatus="status">
												<tr>
													...
													<td><a
														href="${path}/admin/manageList/detail?no=${list.getUserID()}"><c:out
								...
								<hr>
									...
									<div id="auth">
										...
										<label for="grade">권한</label> <select id="selectRole" name="SelectRole">
											<option value=" " selected>-선택-</option>
											<option value="관리자">관리자</option>
											<option value="학생">학생</option>
											<option value="교수">교수</option>
											
										</select> <input type="button" value="변경" id="change" class="changeButton">
										<script>
										// ajax 통신을 위한 csrf 설정
										...
										if(token && header) {
										 ...
										 <input
											type="button" value="←" id="leftList"> <input
