					...
					<div class="user">
						<input type=text class="col-sm-3 mb-0 font-weight-bold text-gray-800" name="UserName" id="userInfo"
							...
							<div class="btn btn-light btn-icon-split">
                                ...
                                <input type=text class="small" name="Colleges" id="userInfo" value="${Colleges}" disabled readonly>
                            </div>
                            <div class="my-2"></div>
                            <div class="btn btn-light btn-icon-split">
								<span class="icon small font-weight-bold text-gray-800">학과</span>
                                <input type=text class="small" name="UserMajor" id="userInfo" value="${UserMajor}" disabled readonly>
                            </div>
                            <div class="my-2"></div>
                            <div class="btn btn-light btn-icon-split">
								<span class="icon small font-weight-bold text-gray-800">학년</span>
                                <input type="text" class="small" name="UserGrade" id="userInfo" value="${UserGrade}" disabled readonly> <span class="small" id="userGrade">학년</span>
                            </div>						
							<div class="userRole">
