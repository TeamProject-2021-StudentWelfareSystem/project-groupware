					...
					<div class="leftInfo">
						...
						<div class=userName>
							<input type=text name="UserName" id="userName"
								value=${UserName
								} disabled readonly>님<br>안녕하세요!
						</div>
						<div class="userColleges">
							<h4>
								소속 : <input type=text name="SC" id="sc" value=${SC } disabled
									readonly>
							</h4>
						</div>
						<div class="userMajor">
							<h4>
								학과 : <input type=text name="UserMajor" id="userMajor"
									value=${UserMajor } disabled readonly>
							</h4>
						</div>
				...
				<div class="rightBox">
					<section id="memberInfo">
						...
						<div id="myPageProfessor" style="display: block;">
							...
							<form action="${path}/myPageProfessor.do" name="ProfessorPage"
								method="POST" id="form">
								...
								<table>
									...
									<tr>
										...
										<td class="col2"><input type="text"
											name="ProfessorColleges" id="professorColleges"
											class="inputBox" disabled readonly value=${ProfessorColleges}></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="col2"><input type="text" name="ProfessorRoom"
											...
											disabled readonly value=${ProfessorRoom}></td>
									</tr>
									<tr>
										<td class="col1"><label for="RoomNum">교수실 전화번호</label></td>
										<td class="col2"><input type="text"
											name="ProfessorRoomNum" id="professorRoomNum"
											class="inputBox" autocomplete="off" disabled readonly
