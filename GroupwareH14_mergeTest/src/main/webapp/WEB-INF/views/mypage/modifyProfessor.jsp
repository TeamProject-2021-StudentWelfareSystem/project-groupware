		...
		<div class="container">
			<section id="modify">
				...
				<div id="modifyProfessor" style="display: block;">
					<form action="${path}/modifyProfessor.do" name="ModifyProfessor.do" method="POST" id="form">
						...
						<table>
							...
							<tr>
								...
								<td class="col2"><input type="text" name="ProfessorRoom"
									id="professorRoom" class="inputBox" autocomplete="off" value=${ProfessorRoom}></td>
							</tr>
							<tr>
								<td class="col1"><label for="professorRoom">교수실 전화번호</label></td>
								<td class="col2"><input type="text" name="ProfessorRoomNum"
									id="professorRoomNum" class="inputBox" autocomplete="off" value=${ProfessorRoomNum}>
								<br><br></td>
							</tr>
							<tr>
