...
public class BoardServiceImpl implements BoardService {
	...
	public List<Board> SelectInquiryBoardList() {
		return boardDao.SelectInquiryBoardList();
	}
	@Override
	...
	public Board SelectOneInquiryContent(String boardID) {
		return boardDao.SelectOneInquiryContent(boardID);
	}
	@Override
	...
	public void DeleteInquiry(int boardID) {
		boardDao.DeleteInquiry(boardID);
	}
	@Override
	...
	public List<Map<String, Object>> SelectInquiryFileList(int BNo) {
		List<Map<String, Object>> SelectInquiryFileList = boardDao.SelectInquiryFileList(BNo);
		return SelectInquiryFileList;
	}
	@Override
	public Map<String, Object> SelectInquiryFileInfo(Map<String, Object> map) {
		Map<String, Object> SelectInquiryFileInfo = boardDao.SelectInquiryFileInfo(map);
