		...
		<nav>
			<div class="mbody">
				<div class="mcontWidth">
						...
						<section>
							<div class="section2">
								...
								<table id="contentTable">
									<tr id="title">
										<td><input type="text" name="BulletinTitle" id="bulletinTitle"
											class="inputBox" placeholder="제목" disabled readonly
											value=${EmailTitle}></td>
									</tr>
									<tr id="receive">
										<td colspan="2">
											<input type="text" name="BulletinWriter"
											id="bulletinWriter" class="inputBox" placeholder="작성자" disabled
											readonly value=${BulletinWriter}> 
											<input type="text"name="BulletinDate" 
											id="bulletinDate" class="inputBox"
											placeholder="날짜" disabled readonly value=${BulletinDate}>
										</td>
									</tr>
									<tr id="content">
										<td>
											<input type="text" name="BulletinContent"	
											id="bulletinContent" class="inputBox" placeholder="내용" disabled
											readonly value="BulletinContent"}>													
					                 		<c:out value="${BulletinContent}" escapeXml="false" />
										</td>
									</tr>
								</table>
								<hr>
					...
					<!-- right_box -->
					<a href="BulletinList"><input type="button" value="목록"
													id="listButton"></a>
					</div>
