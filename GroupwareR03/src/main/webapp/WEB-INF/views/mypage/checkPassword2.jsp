                        ...
                        <div class="col-lg-12">
                             <div class="p-5">
                             	<div class="text-center">
                                     <h4 class="text-gray-900 mb-4">비밀번호 확인</h4>
                                </div>
                                <form action="${path}/checkPassword2.do" name="CheckPwd" method="POST" id="form">
                                	<div class="form-group user">
                                	<input type="password" class="form-control form-control-user" 
                                		name="UserLoginPwd" id="userLoginPwd" value="${UserLoginPwd}" autofocus placeholder="password">
									...
									<div class="text-center">
										<input type="submit" id="modifyBtn" class="btn btn-primary btn-user" value="확인">
