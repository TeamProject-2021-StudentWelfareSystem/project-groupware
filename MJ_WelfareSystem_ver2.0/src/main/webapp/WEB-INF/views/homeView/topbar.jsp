...
<body>
	...
	<nav
		...
		<ul class="navbar-nav ml-auto">
			...
			<!-- Nav Item - 관리자 설정 -->
			<li class="nav-item dropdown no-arrow mx-1"><sec:authorize
					access="hasRole('ROLE_ADMIN')">
					<a class="nav-link dropdown-toggle" href="${path}/admin/manageList"
						id="alertsDropdown" role="button"> <i class="fas fa-user-cog"></i>
					</a>
				</sec:authorize></li>
			...
			<li class="nav-item dropdown no-arrow mx-1"><sec:authorize
					...
					<a class="nav-link dropdown-toggle"
						...
						role="button"> <i class="fas fa-info-circle"></i>
					</a>
				</sec:authorize></li>

			<!-- Nav Item - 회원가입 -->
			<li class="nav-item dropdown no-arrow mx-1"><sec:authorize access="isAnonymous()">
