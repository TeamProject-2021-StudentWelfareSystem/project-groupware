...
<body>
	...
	<div class="container">
		<section id="signup">
				...
				<table>
					<form action="${path}/signup.do" name="signup" method="POST"
						...
						<tr>
							...
							<!-- 아이디중복확인 -->
							<td class="col2"><input type="text" name="LoginID"
								id="userLoginID" class="inputBox" placeholder="" autofocus
								autocomplete="off" value=${check}></td>
							<td class="col3"><input type="submit" value="중복 확인"
								 name = "IdCheck"id="id_check"></td>
						</tr>
						<tr>
			...
			<div id="">
				<input type="submit" value="회원가입" id="submit" name="submitName">
			</div>
			</form>
		</section>
	</div>
