      ...
      <div class="mbody">
         <div class="mcontWidth">
            ...
            <div class="rightBox">
               ...
               <section>
                  <form action="CommunityDelete.do?boardID=${BoardID}" name="CommunityDelete"
                     method="POST" id="form">
                     <div class="section2">
                        ...
                        <table id="contentTable">
                           ...
                           <tr id="receive">
                              ...
                              <input type="text" name="Date" id="date" class="inputBox"
                                 placeholder="날짜" disabled readonly value="${BoardDate}">
                              </td>
                           </tr>
                           <tr id="content">
                              <td><textarea name="CommunityContent"
                                    id="communityContent" class="inputBox" placeholder="${CommunityContent}"
                                    disabled readonly></textarea> <c:out
                                    value="" escapeXml="false" /></td>
                           </tr>
                        </table>
                        <hr>
                        <table>
                     ...
                     <div id="btn">
						...
						<c:if test="${UserID == UserIDFromWriter}">
							<a href="${path}/communityModify?boardID=${BoardID}"><button type="button"
