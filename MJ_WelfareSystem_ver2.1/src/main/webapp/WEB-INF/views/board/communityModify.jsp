	 ...
	 <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="card-body">
				 <form action="CommunityModify.do?${_csrf.parameterName}=${_csrf.token}"
					...
					<div class="form-group col-sm-10 my-5 ml-4">
						...
						<div class="col-sm-10">
							<textarea name="CommunityContent" class="form-control" id="communityContent">${CommunityContent}</textarea>
						    <script>
						    ClassicEditor
						 ...
						 <div class="form-group row">
				            <label for="files" class="col-sm-2 my-1 col-form-label"><h6 class=" font-weight-bold text-gray-800">첨부 파일 추가</h6></label>
				         ...
				         <div class="form-group row">
				         	<label for="files" class="col-sm-2 my-2 col-form-label"><h6 class="font-weight-bold text-gray-800">기존 첨부 파일</h6></label>
