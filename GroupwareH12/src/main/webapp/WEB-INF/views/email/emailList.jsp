			...
			<div class="menubar">
				<div class="menubarWidth">
					...
					<div class="menubarMid">
						<ul class="topInfo">
							<li><a href="">사이트맵</a></li>
							<li><a href="${path}/myPageStudent">마이페이지</a></li>
							<li><a href="">문의</a></li>
							<!-- sign out -->
						...
						<!-- 메뉴 -->
						<ul class="topMenu">
							<li id="homeTab" class="tMenu"><a href="${path}/homeLogin"><span
									class="tmenuPackMover">홈</span></a></li>
							<li id="mailTab" class="tMenu"><a
								href="${path}/email/emailLogin"><span class="tmenuPackMover">메일</span></a></li>
