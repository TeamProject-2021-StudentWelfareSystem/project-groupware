				...
				<div class="mcontWidth">
								...
								<table id="contentTable">
									<tr id="title">
										<td><input type="text" name="InquiryTitle"
											id="inquiryTitle" class="inputBox" placeholder="제목"
											disabled readonly value=${InquiryTitle}></td>
									</tr>
									<tr id="receive">
									...
									<tr id="content">
										<td><input type="text" name="InquiryContent"
											id="inquiryContent"  class="inputBox"  placeholder="내용" 
							 											readonly  value=${InquiryContent}> <c:out
					...
					<div>
						...
						<c:if test="${list.UserLoginID == board.UserID}">
							<a href="${path}/inquiryModify"><button type="button" id="listButton" >수정</button></a>
							<button type="button" id="listButton" onClick="boardDelete()">삭제</button>
						</c:if>
					</div>
