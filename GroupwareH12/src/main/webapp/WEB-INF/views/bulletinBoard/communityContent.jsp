				...
				<div class="mcontWidth">
						...
						<section>
							<div class="section2">
								...
								<table id="contentTable">
									...
									<tr id="content">
										<td><input type="text" name="CommunityContent"
											id="communityContent"  lass="inputBox"  laceholder="내용" 
							 											readonly  alue=${CommunityContent}> <c:out
												value="${CommunityContent}" escapeXml="false" /></td>
									</tr>
								</table>
								<hr>
					...
					<div>
						...
						<c:if test="${list.UserLoginID == board.UserID}">
							<a href="${path}/communityModify"><button type="button" id="listButton" >수정</button></a>
