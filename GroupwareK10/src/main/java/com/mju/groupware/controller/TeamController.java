...
public class TeamController {
	...
	public String createTeam(User user, Model model, Principal Principal, HttpServletRequest request,RedirectAttributes rttr) {
	...
	public String createTeamDO(Class classInfo, Team team, Model model, Principal Principal, 
			User user, HttpServletRequest request, TeamUser teamUser) {
		// class 정보
