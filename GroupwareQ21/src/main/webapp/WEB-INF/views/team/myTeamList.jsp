								...
								<div id="dataTable_wrapper"
									...
									<div class="row">
										...
										<div class="col-sm-12 col-md-2" id="right">
											<form
												class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search mt-5 pt-3">
									...
									<div class="row">
										...
										<div class="col-sm-12 col-md-7">
											<div class="dataTables_paginate paging_simple_numbers"
												...
												<ul class="pagination">
													<li
														class="paginate_button page-item previous ${(pageMaker.cri.page==1) ||(pageMaker.cri.page)==(pageMaker.endPage) ? 'disabled':''}"
														id="dataTable_previous"><a
														href='<c:url value="/team/myTeamList?page=${pageMaker.cri.page-1}"/>'
													...
													<c:forEach begin="${pageMaker.startPage}"
														...
														<li
															class="paginate_button page-item ${pageMaker.cri.page==pageNum ? 'active':'' }">
															<a
															href='<c:url value="/team/myTeamList?page=${pageNum}"/>'
													...
													<c:if test="${pageMaker.endPage > 0 }">
														<li
															class="paginate_button page-item next ${(pageMaker.cri.page)==(pageMaker.endPage) ? 'disabled':'' }"
															id="dataTable_next"><a
															href='<c:url value="/team/myTeamList?page=${pageMaker.cri.page+1 }"/>'
