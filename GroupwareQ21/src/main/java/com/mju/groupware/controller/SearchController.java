...
public class SearchController {
	...
	public String searchUser(Principal principal, Model model, User user, Criteria cri) {
		// 유저 정보
	...
	public List<HashMap<String, Object>> DoSearchUser(Principal principal, Model model, HttpServletRequest request,
			@RequestBody SearchKeyWord searchKeyWord, Criteria cri) {
	...
	public String reviewList(Principal principal, Model model, User user, HttpServletRequest request, RedirectAttributes rttr, Criteria cri) {
		// 유저 정보
		GetUserInformation(principal, user, model);
		...
		pageMaker.setTotalCount(searchService.CountTotalUserReview(UserID));
		
		cri.setUserID((Integer.parseInt(UserID)));
		List<UserReview> ReviewList = searchService.SelectUserReviewPN(cri);		
		System.out.println(ReviewList);
		System.out.println(searchService.CountTotalUserReview(UserID));
