...
public interface BoardDao {
	...
	List<Board> SelectCommunityBoardListPN(Criteria cri);

	List<Board> SelectNoticeBoardListPN(Criteria cri);

	int CountTotalCommunityBoardList();
	
	int CountTotalNoticeBoardList();

	int CountTotalMyPostList(String userLoginID);
