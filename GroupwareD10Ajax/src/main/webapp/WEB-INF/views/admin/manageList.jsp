							...
							<div class="section2">
								...
								<form>
									<table class="userList">
										<thead>
											<tr>
												<th><input type="checkbox" class="checkAll" id="checkAll" name="CheckAll">
												<script>
										...
										<c:forEach items="${list}" var="list" varStatus="status">
											<tr>
												<td><input type="checkbox" name="RowCheck" class="check" data-listNum="${status.count}" />
												<script>
								...
								<form>
									<div id="page" class="btn">
										...
										<input type="button" value="삭제" data-listNum="${status.count}" class="selectDelete_btn" id="delete" style="text-align: right;">
										<script>
										 $(".selectDelete_btn").click(function(){
										  ...
										  if(confirm_val) {
										   ...
										   $("input[class='check']:checked").each(function(){
										    checkArr.push($(this).attr("data-listNum"));		
										   });
										    
										   $.ajax({
										    url : "/admin/withdrawal.do",
										    type : "POST",
										    data : { check : checkArr },
